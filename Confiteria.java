...
public class Confiteria implements java.io.Serializable{
	...
	public Confiteria() {
		 ...
		 empleados[1] = new Empleado("Favio Carbajal Apaza", 23571113, 29, 5500, "Recursos Humanos");
		 empleados[2] = new Empleado("Dario Quispe Mamani",	78975691, 27, 6200,	"Pastelero");
		 empleados[3] = new Empleado("Rose Siñani Valencia", 59873147, 22, 3100, "Empacadora");
		 empleados[4] = new Empleado("Benito Martínez Ocasio", 63598374, 28, 6250, "Chef");
		 nroProductos = 1;
